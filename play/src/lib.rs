//! `sc-play` — turn streamcraft into a general-purpose media player: hand it any supported
//! file and it probes the container, builds the pipeline, and plays it (spec:
//! streamcraft.md Milestone applications §5; no-bins §453–475 — autoplug is a **controller
//! library**, not a self-modifying graph element; roadmap item 8 — "autoplug controller").
//!
//! The library is the reusable half of the [`scplay`](../scplay/index.html) binary: a
...
//! - [`seek`] — time→byte [`SeekIndex`](streamcraft_core::pipeline::SeekIndex) building;
